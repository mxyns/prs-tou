...
void string_test() {
    ...
    printf("pute = ["); for(int i = 0; i < strlen(pute) + 1; i++) printf("%d ", pute[i]); printf("]\n");
    printf("salope = ["); for(int i = 0; i < strlen(salope) + 1; i++) printf("%d ", salope[i]); printf("]\n");
